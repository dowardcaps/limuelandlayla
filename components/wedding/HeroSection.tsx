    ...
    <main className="collage-enter">
      ...
      <section className="mx-auto w-full max-w-4xl px-4 pb-12 pt-10 sm:px-5 sm:pb-16 sm:pt-14 md:px-10 md:pt-20">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-6 sm:gap-6">
          ...
          <ScrollReveal className="sm:col-start-1 sm:col-span-3 sm:row-start-1">
            <div className="flex h-full flex-col items-center justify-center gap-2 border border-navy/15 bg-white px-4 py-6 text-center paper-shadow-soft sm:items-start sm:px-6 sm:py-8 sm:text-left md:gap-3">
              <Monogram size="md" />
              <div>
                <p className="font-script text-2xl leading-none text-navy sm:text-3xl md:text-4xl">
                  {couple.first} &amp; {couple.second}
                </p>
                <p className="tracked mt-1.5 text-lg text-navy sm:text-md">
          ...
          {/* Primary photo */}
          <ScrollReveal delayMs={80} className="sm:col-start-4 sm:col-span-3 sm:row-start-1">
            <PhotoCard
          ...
          {/* Save the date */}
          <ScrollReveal delayMs={120} className="sm:col-start-1 sm:col-span-2 sm:row-start-2">
            <SaveTheDate rotate="rotate-1" />
          </ScrollReveal>

          {/* Nav tiles -> each is its own routed page */}
          <ScrollReveal delayMs={160} className="sm:col-start-3 sm:col-span-2 sm:row-start-2">
            <NavTile href="/rsvp" eyebrow="Kindly" label="RSVP here" rotate="-rotate-1" />
          </ScrollReveal>
          <ScrollReveal delayMs={200} className="sm:col-start-5 sm:col-span-2 sm:row-start-2">
            <NavTile href="/details" label="Click for the DETAILS" rotate="rotate-1" />
          </ScrollReveal>

          {/* Small photo pair + FAQ circle */}
          <ScrollReveal delayMs={80} className="sm:col-start-1 sm:col-span-2 sm:row-start-3">
          ...
          <ScrollReveal delayMs={160} className="sm:col-start-5 sm:col-span-2 sm:row-start-3">
            <PhotoCard alt="A quiet moment" rotate="-rotate-1" aspect="aspect-square" />
          </ScrollReveal>

          {/* Full-width row with Entourage and Attire */}
          <ScrollReveal delayMs={100} className="sm:col-start-1 sm:col-span-3">
            <NavTile href="/entourage" label="Our ENTOURAGE" />
          </ScrollReveal>
          <ScrollReveal delayMs={140} className="sm:col-start-4 sm:col-span-3">
        ...
        <div className="mt-12 flex flex-col items-center gap-2 text-navy/45 sm:mt-16">
          ...
          <p className="tracked text-[0.6rem]">Browse the sections above</p>
        </div>
      </section>
